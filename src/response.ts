...
import { instanceToPlain, plainToInstance, ClassConstructor, ClassTransformer } from "class-transformer";
...
export class HttpResponse {
    static Ok<T extends {}>(obj: any, s?: any) {
        if (s) {
            ...
            const data = instanceToPlain(plainToInstance(s, pg ? obj.data : obj, { enableImplicitConversion: true, exposeUnsetFields: false }), { strategy: 'excludeAll' });
            if (pg) {
